...
const Home = () => {
  ...
  useEffect(() => {
    if (location.pathname === '/technologies' || location.pathname === '/blogs') {
  ...
  return (
    <div className="bg-[#050816] text-white overflow-x-clip w-full max-w-[100vw]">
      ...
      <section className="px-6 md:px-10 lg:px-16 py-10 md:py-20 md:py-28">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.h2 variants={fadeInUp} className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-white leading-tight">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-purple-500">Premium</span> digital solutions for <span className="text-cyan-400">brands</span> that want to <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 italic font-serif">stand out.</span>
            </motion.h2>
      ...
      <section id="technologies" className="relative overflow-hidden px-6 md:px-10 lg:px-16 py-10 md:py-20 md:py-28">
        ...
        <div className="relative z-10 mx-auto max-w-7xl overflow-hidden rounded-[36px] border border-cyan-400/10 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.14),transparent_35%),linear-gradient(135deg,#0a0f1d_0%,#050816_100%)] shadow-[0_30px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
          <video
            autoPlay
            loop
            muted
            playsInline
            className="absolute inset-0 z-0 h-full w-full object-cover opacity-30 mix-blend-screen pointer-events-none"
            src={techVideoBg}
          />
          <div className="absolute inset-0 z-0 bg-[#0a0f1d]/60 backdrop-blur-[1px]" />
                    ...
                    <div key={group.title}>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {group.items.map((item) => {
                          const ItemIcon = item.icon;
                          return (
                            <div key={item.name} className="flex items-center gap-2 rounded-full border border-cyan-400/15 bg-cyan-400/10 px-3 py-2 text-sm text-gray-200 shadow-[0_0_0_1px_rgba(255,255,255,0.03)] backdrop-blur-sm">
